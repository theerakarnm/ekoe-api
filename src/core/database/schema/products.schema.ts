...
export const productSets = pgTable("product_sets", {
  id: serial("id").primaryKey(),
  setProductId: integer("set_product_id").notNull().references(() => products.id, { onDelete: "cascade" }),
  includedProductId: integer("included_product_id").notNull().references(() => products.id, { onDelete: "cascade" }),
...
export const productGifts = pgTable("product_gifts", {
  id: serial("id").primaryKey(),
  productId: integer("product_id").notNull().references(() => products.id, { onDelete: "cascade" }),
  giftId: integer("gift_id").notNull().references(() => complimentaryGifts.id, { onDelete: "cascade" }),
